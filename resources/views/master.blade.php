...
<div class="wrapper">
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body chat" id="chat-box">
                            ...
                            <!-- chat item -->
                            <div class="item">
                                <img src="{{ asset( 'img/user2-128x128.jpg' ) }}" alt="user image" class="offline">
                                <p class="message">
                                    <a href="#" class="name">
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; {{ Carbon\Carbon::now()->year }} <a href="javascript:;">Nepal Scout</a>.</strong> All rights reserved.
    </footer>
