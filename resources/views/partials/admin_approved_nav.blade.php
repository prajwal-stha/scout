<div class="box-body no-padding">
    <ul class="nav nav-pills nav-stacked">
        ...
        <li{!! Request::is('admin/approved-lead-scouter/*') ? ' class="active"': '' !!}>
            ...
            <a href="{{ url('admin/approved-lead-scouter', [$organization->original_id]) }}"><i class="fa fa-user-plus"></i>Scout Master Detail</a>
        ...
        <li{!! Request::is('admin/approved-scouter/*')  ? ' class="active"': '' !!}>
            ...
            <a href="{{ url('admin/approved-scouter', [$organization->original_id]) }}"><i class="fa fa-user-plus"></i> Assistant Scout Master Detail</a>

        </li>

        <li{!! Request::is('admin/approved-teams/*')  ? ' class="active"': '' !!}>

            <a href="{{ url('admin/approved-teams', [$organization->original_id]) }}"><i class="fa fa-users"></i> Units</a>
