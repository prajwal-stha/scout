    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Assistant Scout Master Detail : {{ $organization->name }}</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    ...
                    {{ Form::model($scouter, ['url' => ['admin/scouter', $scouter['id']], 'method' => 'PATCH', 'class' => 'form-horizontal']) }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        {{ Form::label('lead-scouter', 'Assistant Scout Master *', array( 'class' => 'control-label col-sm-6')) }}
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group{{ $errors->has('permission') || $errors->has('permission_date') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
                                            {{ Form::text('permission_date', null, array('class' => 'form-control date', 'id' => 'lead_perm_date','placeholder' => 'Date', 'data-inputmask' => '"alias": "dd/mm/yyyy"')) }}
                                    ...
                                    <div class="form-group{{ $errors->has('btc_no') || $errors->has('btc_date') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-3">
                                            {{ Form::text('lead_btc_date', null, array('class' => 'form-control date', 'id' => 'lead_btc_date', 'placeholder' => 'Date', 'data-inputmask' => '"alias": "dd/mm/yyyy"')) }}
                                    ...
                                    <div class="form-group{{ $errors->has('alt_no') || $errors->has('alt_date') ? ' has-error' : '' }}">
                                        ...
                                        {{ Form::label('lead_alt_no', 'Ceritificate No. / Date', array( 'class' => 'control-label col-sm-6')) }}
                        ...
                        <div class="box-footer">
                            <div class="pull-right">
                                ...
                                {{ link_to('admin/teams/'.$organization->id, 'NEXT', array('class' => 'btn btn-default')) }}
                            </div>
                        </div>
