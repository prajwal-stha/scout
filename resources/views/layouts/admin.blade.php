            ...
            <ul class="sidebar-menu">
                ...
                Request::path() == 'admin/declined-organizations' ||  Request::path() == 'scouter/index' ? 'active': '' !!}">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ url('admin/approved-organizations') }}">All Approved Unit</a></li>
                        <li><a href="{{ url('admin/declined-organizations') }}">All Declined Unit</a></li>
                        <li><a href="{{ url('scouter/index') }}">Add New</a></li>
                    </ul>
                </li>
