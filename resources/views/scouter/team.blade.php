...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ isset($organization) && $organization->isSubmitted()
                    && $organization->isRegistered() ? 'Units : '. $organization->name : 'Manage Units : '.$organization->name }}</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                                ...
                                @foreach($team as $value)
                                    <tr>
                                        <td><a class="team-name"
                                               href="{{ url( 'scouter/team', [$organization->id, $value->id]) }}">{{ $value->name }}</a>
                                        </td>
                                        <td>{{ $value->gender }}</td>
                                        <td>{{ $value->type }}</td>
                                        @if(isset($organization))
                ...
                @if(isset($organization))
                    @if(!$organization->isSubmitted() && !$organization->isRegistered())
                        ...
                        <div class="box-footer">
                            <div class="pull-right">
                                ...
                                @if(isset($organization))
                                    @if(!$organization->isSubmitted() && !$organization->isRegistered())
                                        <a class="btn btn-default" href="{{ url('scouter/registration', [$organization->id]) }}">NEXT</a>
                    ...
                    @else
                        <div class="box-body">
                            ...
                            @if(isset($team))
                                @if(!is_null($team_name))
                                    <h3 class="box-subtitle border-bottom"> Unit Members of : {{ $team_name }}</h3>
                ...
                @if(isset($organization))
                    @if($organization->isSubmitted() && $organization->isRegistered())
                        ...
                        <div class="box-footer">
                            <div class="pull-right">
                                <a href="{{ url('scouter/registration', [$organization->id]) }}" class="btn btn-default">NEXT</a>
...
@section('scripts')
    ...
    @parent
    <script>
        var index_team_url = "<?php echo isset($organization) ? url('scouter/team', [$organization->id]) : url('scouter/team'); ?>";
