...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="box box-success">
                <div class="box-header with-border">
                    <h3 class="box-title">Scout Master Detail {{ isset($organization) ? ': '. $organization->name : '' }}</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group{{ $errors->has('advance_no') || $errors->has('advance_date') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-3">
                                    {{ Form::text('advance_no', null, array('class' => 'form-control', 'id' => 'lead_advance_no', 'placeholder' => 'Advance Certificate No.')) }}
                    ...
                    <div class="pull-right">
                        @if(isset($org_id))
                            @if(!$organization->isSubmitted() && !$organization->isRegistered())
                                ...
                                <a href="{{ url('scouter/scouter', [$org_id]) }}" class="btn btn-default">NEXT</a>
                            @else
                                <a href="{{ url('scouter/scouter', [$org_id]) }}" class="btn btn-default">NEXT</a>
                            @endif
